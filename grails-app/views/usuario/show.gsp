	...
	<body>
		...
		<div id="show-usuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list usuario">
				...
				<g:if test="${usuarioInstance?.confirmacionPassword}">
				<li class="fieldcontain">
					<span id="confirmacionPassword-label" class="property-label"><g:message code="usuario.confirmacionPassword.label" default="Confirmacion Password" /></span>
					
						<span class="property-value" aria-labelledby="confirmacionPassword-label"><g:fieldValue bean="${usuarioInstance}" field="confirmacionPassword"/></span>
				...
				<g:if test="${usuarioInstance?.numeroTelefonico}">
				<li class="fieldcontain">
					<span id="numeroTelefonico-label" class="property-label"><g:message code="usuario.numeroTelefonico.label" default="Numero Telefonico" /></span>
					
						<span class="property-value" aria-labelledby="numeroTelefonico-label"><g:fieldValue bean="${usuarioInstance}" field="numeroTelefonico"/></span>
