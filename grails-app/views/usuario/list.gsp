			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="confirmacionPassword" title="${message(code: 'usuario.confirmacionPassword.label', default: 'Confirmacion Password')}" />
				...
				<g:each in="${usuarioInstanceList}" status="i" var="usuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: usuarioInstance, field: "confirmacionPassword")}</td>
