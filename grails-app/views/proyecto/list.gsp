			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="lastUpdated" title="${message(code: 'proyecto.lastUpdated.label', default: 'Last Updated')}" />
				...
				<g:each in="${proyectoInstanceList}" status="i" var="proyectoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${proyectoInstance.lastUpdated}" /></td>
